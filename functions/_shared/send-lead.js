// Backup email notification for website form submissions. The CRM webhook
// (forward-to-crm.js) is the primary path; this email fires in parallel as
// belt-and-suspenders insurance so leads never sit silently if either the
// CRM is down or OpenPhone SMS delivery is blocked (A2P 10DLC pending, etc).
//
// Required env vars on the website Pages project:
//   RESEND_API_KEY — from resend.com
//   NOTIFY_EMAIL   — inbox for residential leads (default: leads@transitionfl.com)
//   DEALS_EMAIL    — inbox for deal submissions  (default: deals@transitionfl.com)
